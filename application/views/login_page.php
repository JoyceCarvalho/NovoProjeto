...
<html>
  ...
  <body>
    ...
    <section class="login-content">
      ...
      <div class="login-box">
        <form class="login-form" action="<?=base_url("login/logar");?>" method="post">
          <h3 class="login-head"><i class="fa fa-lg fa-fw fa-user"></i>SIGN IN</h3>
          <div class="form-group">
            <label class="control-label">USUÁRIO</label>
            <input class="form-control" type="text" placeholder="Usuário" autofocus>
          </div>
          <div class="form-group">
        ...
        <form class="forget-form" action="<?=base_url();?>" method="post">
          ...
          <div class="form-group btn-container">
            <button class="btn btn-primary btn-block"><i class="fa fa-unlock fa-lg fa-fw"></i>NOVA SENHA</button>
          </div>
    ...
    <script src="<?=base_url("assets/Majs/plugins/pace.min.js");?>"></script>
